...
// @{
/** @brief Client command PutOnOffSchedule
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 * Command: PutOnOffSchedule
 * @param OnOffscheduleStr uint8_t*
 */
#define emberAfFillCommandManagerPutOnOffSchedule(OnOffscheduleStr) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
...
/** @brief Client command GetOnOffSchedule.
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 ...
 * @param OnOffscheduleStr uint8_t*
 */
#define emberAfFillCommandManagerGetOnOffSchedule(OnOffscheduleStr) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_GET_ON_OFF_SCHEDULE_COMMAND_ID, \
                                                "s", \
                                                OnOffscheduleStr);


/** @brief Client command PutDimmingSchedule.
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 * Command: PutDimmingSchedule
 * @param dimmingScheduleStr uint8_t*
 */
#define emberAfFillCommandManagerPutDimmingSchedule(dimmingScheduleStr) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_PUT_DIMMING_SCHEDULE_COMMAND_ID, \
                                                "s", \
                                                dimmingScheduleStr);


/** @brief Client command GetDimmingSchedule.
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 * Command: GetDimmingSchedule
 * @param dimmingScheduleStr uint8_t*
 */
#define emberAfFillCommandManagerGetDimmingSchedule(dimmingScheduleStr) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_GET_DIMMING_SCHEDULE_COMMAND_ID, \
                                                "s", \
                                                dimmingScheduleStr);


/** @brief Client command GetGroup.
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 * Command: GetGroup
 * @param groupStr uint8_t*
 */
#define emberAfFillCommandManagerGetGroup(groupStr) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_GET_GROUP_COMMAND_ID, \
                                                "s", \
                                                groupStr);


/** @brief Client command PutGroup.
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 * Command: PutGroup
 * @param groupStr uint8_t*
 */
#define emberAfFillCommandManagerPutGroup(groupStr) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_PUT_GROUP_COMMAND_ID, \
                                                "s", \
                                                groupStr);


/** @brief Client command GetReportTime.
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 * Command: GetReportTime
 * @param reportStr uint16_t
 */
#define emberAfFillCommandManagerGetReportTime(reportStr) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_GET_REPORT_TIME_COMMAND_ID, \
                                                "v", \
                                                reportStr);


/** @brief Client command PutReportTime.
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 * Command: PutReportTime
 * @param reportStr uint16_t
 */
#define emberAfFillCommandManagerPutReportTime(reportStr) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_PUT_REPORT_TIME_COMMAND_ID, \
                                                "v", \
                                                reportStr);


/** @brief Client command GetHistoricalEvent.
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 * Command: GetHistoricalEvent
 */
#define emberAfFillCommandManagerGetHistoricalEvent() \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_GET_HISTORICAL_EVENT_COMMAND_ID, \
                                                "");


/** @brief Client command PutHistoricalEvent.
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 * Command: PutHistoricalEvent
 * @param HistoryStr uint8_t*
 */
#define emberAfFillCommandManagerPutHistoricalEvent(HistoryStr) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_PUT_HISTORICAL_EVENT_COMMAND_ID, \
                                                "s", \
                                                HistoryStr);


/** @brief Client command GetPing.
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 * Command: GetPing
 * @param Ping uint8_t*
 */
#define emberAfFillCommandManagerGetPing(Ping) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_GET_PING_COMMAND_ID, \
                                                "8", \
                                                Ping);


/** @brief Client command PutPing.
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 * Command: PutPing
 * @param Ping uint8_t*
 */
#define emberAfFillCommandManagerPutPing(Ping) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_PUT_PING_COMMAND_ID, \
                                                "8", \
                                                Ping);


/** @brief Client command GetReportRealTime.
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 * Command: GetReportRealTime
 * @param reportTime uint8_t*
 */
#define emberAfFillCommandManagerGetReportRealTime(reportTime) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_GET_REPORT_REAL_TIME_COMMAND_ID, \
                                                "8", \
                                                reportTime);


/** @brief Client command PutReportRealTime.
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 * Command: PutReportRealTime
 * @param reportTime uint8_t*
 */
#define emberAfFillCommandManagerPutReportRealTime(reportTime) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_PUT_REPORT_REAL_TIME_COMMAND_ID, \
                                                "8", \
                                                reportTime);


/** @brief Client command GetDimming.
 *
 * Cluster: Manager, This cluster provides an example of how the Application 
      Framework can be extended to include manufacturer specific clusters.
 * Command: GetDimming
 * @param dimming uint16_t
 */
#define emberAfFillCommandManagerGetDimming(dimming) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_GET_DIMMING_COMMAND_ID, \
                                                "v", \
                                                dimming);
 ...
 * @param dimming uint16_t
 */
#define emberAfFillCommandManagerPutDimming(dimming) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_MANAGER_ID, \
                                                0x10A2, \
                                                ZCL_PUT_DIMMING_COMMAND_ID, \
                                                "v", \
                                                dimming);
